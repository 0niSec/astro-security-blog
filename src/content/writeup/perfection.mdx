...
description: "The writeup for the Hack the Box machine Perfection. This machine is an easy rated Linux box that involves exploiting a Laravel RCE vulnerability and then escalating privileges using a wildcard sudoers file."
pubDate: "5/24/2024"
